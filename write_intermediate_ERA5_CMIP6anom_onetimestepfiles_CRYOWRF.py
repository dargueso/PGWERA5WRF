...
vars2d = ["uas", "vas", "tas", "hurs", "ps", "psl", "ts", "tos", "siconc"]
vars2d_invarERA5 = ["rsn", "sd", "stl1", "stl2", "stl3", "stl4", "swvl1", "swvl2", "swvl3", "swvl4"] #"z",
...
for datetime in datetimes:
    ...
    ferapl = nc.Dataset(
        "%s/ap_pl_%s.nc" % (ERA5_dir, datetime.item().strftime(datetime_fileformat)), "r"
    )
    ferasfc = nc.Dataset(
        "%s/ap_surface_%s.nc" % (ERA5_dir, datetime.item().strftime(datetime_fileformat)), "r"
    )
